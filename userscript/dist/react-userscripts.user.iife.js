...
(function() {
  ...
  function App() {
    return /* @__PURE__ */ React.createElement("div", { className: "flex min-h-screen flex-col items-center justify-center gap-4 p-8" }, /* @__PURE__ */ React.createElement("h1", { className: "text-4xl font-bold text-foreground mb-8" }, "React Userscript com shadcn/ui"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-4 items-center justify-center" }, /* @__PURE__ */ React.createElement(Button, { variant: "default" }, "Botão Padrão"), /* @__PURE__ */ React.createElement(Button, { variant: "secondary" }, "Botão Secundário"), /* @__PURE__ */ React.createElement(Button, { variant: "outline" }, "Botão Outline"), /* @__PURE__ */ React.createElement(Button, { variant: "destructive" }, "Botão Destrutivo"), /* @__PURE__ */ React.createElement(Button, { variant: "ghost" }, "Botão Ghost"), /* @__PURE__ */ React.createElement(Button, { variant: "link" }, "Botão Link")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-4 items-center justify-center mt-4" }, /* @__PURE__ */ React.createElement(Button, { size: "sm" }, "Pequeno"), /* @__PURE__ */ React.createElement(Button, { size: "default" }, "Padrão"), /* @__PURE__ */ React.createElement(Button, { size: "lg" }, "Grande")), /* @__PURE__ */ React.createElement("p", { className: "text-muted-foreground text-center max-w-md mt-8" }, "Este é um exemplo de React userscript usando shadcn/ui. Os componentes estão funcionando corretamente com Tailwind CSS."));
  }
  function log(...args) {
    console.log(
