...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("ppm:text-muted-foreground ppm:text-sm", className)}
      {...props}
    />
  )
}
...
function CardAction({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "ppm:col-start-2 ppm:row-span-2 ppm:row-start-1 ppm:self-start ppm:justify-self-end",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("ppm:flex ppm:items-center ppm:px-6 ppm:[.border-t]:pt-6", className)}
      {...props}
    />
  )
}
